...
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.ACCEPT_ENCODING;
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.CONNECTION;
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.CONTENT_ENCODING;
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.CONTENT_LENGTH;
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.CONTENT_TYPE;
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.GZIP;
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.KEEP_ALIVE;
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.LAST_MODIFIED;
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.NOT_FOUND_404;
import static CN.EDU.SEU.nio.HttpResponceHeaderBuilder.SERVER_ERROR_500;
...
import CN.EDU.SEU.nio.ButterflySoftCache.CacheEntry;
		...
		while (true) {
			...
			try {
				if (header.appendSegment(requestData.data)) {
					...
					if (body != null && header.getVerb() == RequestHeaderHandler.Verb.GET)
