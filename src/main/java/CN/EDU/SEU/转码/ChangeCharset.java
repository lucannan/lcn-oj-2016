...
public class ChangeCharset {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        gbk = changeCharset(ascii, ChangeCharset.US_ASCII, ChangeCharset.GBK);
        System.out.println("再把ASCII码的字符串转换成GBK码: " + gbk);
        System.out.println();
        String iso88591 = toISO_8859_1(str);
        System.out.println("转换成ISO-8859-1码: " + iso88591);
        gbk = changeCharset(iso88591, ChangeCharset.ISO_8859_1, ChangeCharset.GBK);
        ...
        gbk = changeCharset(utf16be, ChangeCharset.UTF_16BE, ChangeCharset.GBK);
        System.out.println("再把UTF-16BE码的字符串转换成GBK码: " + gbk);
        System.out.println();
        String utf16le = toUTF_16LE(str);
        System.out.println("转换成UTF-16LE码:" + utf16le);
        gbk = changeCharset(utf16le, ChangeCharset.UTF_16LE, ChangeCharset.GBK);
        System.out.println("再把UTF-16LE码的字符串转换成GBK码: " + gbk);
        System.out.println();
        String utf16 = toUTF_16(str);
        System.out.println("转换成UTF-16码:" + utf16);
        gbk = changeCharset(utf16, ChangeCharset.UTF_16LE, ChangeCharset.GBK);
